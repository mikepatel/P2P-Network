...
"""
- B begins with 2 RFCs
- register with RS
- query RS for active peer list
- send leave() after 1 RFC sent to A
"""
...
#
peerNumber = 11 # ONLY MAJOR DIFFERNCE ACROSS DIFFERENT PEER FILES
hostName = 'localhost'
...
sleep(5) # delay for peers to register with RS
